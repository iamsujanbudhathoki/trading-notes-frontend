    ...
    return (
        <Link href={href} className="group">
            <Card className="h-full p-8 hover:shadow-soft-lg transition-all duration-300 relative overflow-hidden">
                ...
                <Icon className="w-10 h-10 text-[#B85C38] mb-4 transition-transform duration-300 group-hover:scale-110" />
                <h3 className="font-sans font-bold text-xl text-slate-900 mb-3">
                    {title}
                </h3>
