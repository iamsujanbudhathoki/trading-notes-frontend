            ...
            <div className="max-w-4xl mx-auto px-6 py-16 md:py-24">
                ...
                <div className="space-y-8">
                    <section className="bg-white rounded-xl p-6 border border-slate-200">
                        <h2 className="font-serif font-bold text-lg text-slate-900 mb-3">Introduction</h2>
                    ...
                    <section className="bg-white rounded-xl p-6 border border-slate-200">
                        <h2 className="font-serif font-bold text-lg text-slate-900 mb-3">Information We Collect</h2>
                        ...
                        <ul className="space-y-2 text-sm text-slate-700">
                            <li className="flex items-start gap-2">
                                ...
                                <span><strong className="text-slate-900">Personal Data:</strong> Information you voluntarily provide such as name and email address when subscribing to our newsletter or contacting us.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#B85C38] font-bold mt-1">•</span>
                                <span><strong className="text-slate-900">Usage Data:</strong> Information automatically collected when you visit our site, including IP address, browser type, pages visited, and time spent on pages.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#B85C38] font-bold mt-1">•</span>
                                <span><strong className="text-slate-900">Cookies:</strong> We use cookies and similar tracking technologies to track activity on our website and hold certain information.</span>
                            </li>
                        </ul>
                    </section>

                    <section className="bg-white rounded-xl p-6 border border-slate-200">
                        <h2 className="font-serif font-bold text-lg text-slate-900 mb-3">How We Use Your Information</h2>
                        <p className="text-sm text-slate-700 leading-relaxed mb-3">
                    ...
                    <section className="bg-white rounded-xl p-6 border border-slate-200">
                        <h2 className="font-serif font-bold text-lg text-slate-900 mb-3">Third-Party Services</h2>
                        <p className="text-sm text-slate-700 leading-relaxed">
                    ...
                    <section className="bg-white rounded-xl p-6 border border-slate-200">
                        <h2 className="font-serif font-bold text-lg text-slate-900 mb-3">Your Rights</h2>
                        <p className="text-sm text-slate-700 leading-relaxed mb-3">
                    ...
                    <section className="bg-white rounded-xl p-6 border border-slate-200">
                        <h2 className="font-serif font-bold text-lg text-slate-900 mb-3">Data Security</h2>
                        <p className="text-sm text-slate-700 leading-relaxed">
                    ...
                    <section className="bg-white rounded-xl p-6 border border-slate-200">
                        <h2 className="font-serif font-bold text-lg text-slate-900 mb-3">Changes to This Policy</h2>
                        <p className="text-sm text-slate-700 leading-relaxed">
