    ...
    return (
        <Link href={href} className="group">
            <Card className="h-full p-8 hover:shadow-xl hover:shadow-slate-900/5 transition-all duration-300 relative overflow-hidden border border-slate-100 group-hover:border-emerald-500/30">
                ...
                <Icon className="w-10 h-10 text-emerald-500 mb-4 transition-transform duration-300 group-hover:scale-110" />
                <h3 className="font-serif font-bold text-xl text-slate-900 mb-3 group-hover:text-emerald-600 transition-colors">
                    {title}
                </h3>
