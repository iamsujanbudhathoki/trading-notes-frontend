                ...
                <div className="grid gap-8">
                    ...
                    <div className="bg-white rounded-2xl p-8 border border-slate-100 shadow-xl shadow-slate-900/5">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="w-12 h-12 rounded-xl bg-copper-50 flex items-center justify-center text-copper-600">
                    ...
                    <div className="bg-white rounded-2xl p-8 border border-slate-100 shadow-xl shadow-slate-900/5">
                        ...
                        <ul className="grid sm:grid-cols-2 gap-6">
                            <li className="flex gap-4">
                                <div className="w-1.5 h-1.5 rounded-full bg-copper-500 mt-2.5 flex-shrink-0" />
                                <div>
